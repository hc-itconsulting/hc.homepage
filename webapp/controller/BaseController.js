sap.ui.define(
	...
	function (Controller, UIComponent, History) {
		...
		return Controller.extend("hc.homepage.controller.BaseController", {
			/**
			...
			onImpressumButtonPress: function (oEvent) {
				this.getOwnerComponent().getRouter().navTo("impressum");
			},

			onCopyrightButtonPress: function (oEvent) {
				this.getOwnerComponent().getRouter().navTo("copyright");
			},

			onPrivacyButtonPress: function (oEvent) {
